...
let MapboxAccessToken = "sk.eyJ1Ijoic2FuZ25ndXllbjI1IiwiYSI6ImNsbjhrZzNwMDBuYWEyaXA5dmd3YXRkOGoifQ.hbSoKd5hj7tAaF7Qccs6Pw"
...
class ViewController: UIViewController, MBDrawingViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        assert(MapboxAccessToken != "sk.eyJ1Ijoic2FuZ25ndXllbjI1IiwiYSI6ImNsbjhrZzNwMDBuYWEyaXA5dmd3YXRkOGoifQ.hbSoKd5hj7tAaF7Qccs6Pw", "You must set `MapboxAccessToken` to your Mapbox access token.")
