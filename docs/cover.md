...
```cartfile
github "track-asia/trackasia-directions-swift" ~> ${MINOR_VERSION}
```
...
```swift
.package(url: "https://github.com/track-asia/trackasia-directions-swift.git", from: "0.30.0")
```
